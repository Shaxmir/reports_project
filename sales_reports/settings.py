"""
Django settings for sales_reports project.
...
SECRET_KEY = 'django-insecure-j8*jt1^4k^$gkqp&7^*ei)c29j3%#^cv14tjki4n(fddot_q&x'
...
ROOT_URLCONF = 'sales_reports.urls'
...
WSGI_APPLICATION = 'sales_reports.wsgi.application'
